<template>
  <header class="app-header navbar">
    ...
    <b-link class="navbar-brand" to="Home">team<strong>assist</strong></b-link>
    ...
    <b-nav is-nav-bar class="d-md-down-none">
      <b-nav-item class="px-3"><router-link :to="{name: 'dashboard'}">Dashboard</router-link></b-nav-item>
    </b-nav>
